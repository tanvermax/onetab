...
const instFeatures = [
  {
    ...
    icon: <Building2 className="w-6 h-6 text-[#0098FD]" />,
  },
  {
    ...
    icon: <BarChart3 className="w-6 h-6 text-[#0098FD]" />,
  },
  {
  ...
  },
  {
    ...
    icon: <CloudLightning className="w-6 h-6 text-[#0098FD]" />,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-orange-900/20 text-[#0098FD] font-bold text-xs uppercase tracking-widest mb-6"
          >
            <ShieldCheck size={16} />
          ...
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight mb-6">
            ...
            <span className="text-[#0098FD] text-shadow-sm">সহজ, নিরাপদ ও আধুনিক।</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {instFeatures.map((feature, index) => (
            <motion.div
              ...
              className="group p-8 rounded-[2.5rem] bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:bg-white dark:hover:bg-slate-800 transition-all shadow-sm hover:shadow-2xl hover:shadow-[#0098FD]/10"
            >
              <div className="w-14 h-14 rounded-2xl bg-blue-100 dark:bg-orange-900/30 flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform">
                {feature.icon}
              </div>
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#0098FD]/10 rounded-full blur-3xl" />
          
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="flex items-center gap-6">
              <div className="h-20 w-20 rounded-full bg-[#0098FD] flex items-center justify-center shadow-lg shadow-[#0098FD]/40">
                <Users size={32} />
              </div>
              <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 w-full lg:w-auto">
              <div className="text-center lg:text-left">
                <p className="text-2xl font-black text-[#0098FD]">১০০%</p>
                <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest">ডেটা নিরাপত্তা</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="text-2xl font-black text-[#0098FD]">২৪/৭</p>
              ...
              <div className="text-center lg:text-left col-span-2 sm:col-span-1">
                <p className="text-2xl font-black text-[#0098FD]">স্মার্ট</p>
